...
let hanleclick = (e) => {
  ...
  return (
      ...
      >
        <h2 className="text-3xl font-extrabold text-white text-center mb-6">Sign In</h2>
        ...
        <p className="text-center text-sm text-white mt-6" >
          Don't have an account? <a href="/signup" className="underline text-white" onClick={handleSignUp}>Sign Up</a>
        </p>
      </motion.div>
    </div>
  )
